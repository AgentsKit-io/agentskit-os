...
export function Nav() {
  return (
    <header className="sticky top-0 z-50 glass border-b border-line/70">
      <nav className="container-x flex h-12 items-center justify-between text-[13px]">
        ...
        <div className="flex items-center gap-4 text-ink-muted">
          ...
          <Link href="#waitlist" className="hidden sm:inline-flex h-7 items-center rounded-full bg-accent px-3 text-[12px] font-medium text-surface hover:bg-accent-hover transition">
            Join waitlist
          </Link>
        </div>
      </nav>
...
function Logo() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <circle cx="4" cy="6" r="2" stroke="#f5f5f7" strokeWidth="1.5" />
      <circle cx="4" cy="18" r="2" stroke="#f5f5f7" strokeWidth="1.5" />
      <circle cx="20" cy="6" r="2" stroke="#f5f5f7" strokeWidth="1.5" />
      <circle cx="20" cy="18" r="2" stroke="#f5f5f7" strokeWidth="1.5" />
      <path d="M6 6 L9 11 M6 18 L9 13 M18 6 L15 11 M18 18 L15 13" stroke="#f5f5f7" strokeOpacity="0.6" strokeWidth="1.2" />
    </svg>
  );
}
